...
export const GAS_URL = import.meta.env.PROD 
  ? "/api/gas" 
  : "https://script.google.com/macros/s/AKfycbx9KplRj5m9rqIfMJt9VlcptrmqZ2lD_AVxA3nOidlwXhneFBnoMFNVkxcWO2G80K9r4Q/exec";
