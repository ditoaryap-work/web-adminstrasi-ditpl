<template>
  <div class="min-h-screen flex items-center justify-center p-4 sm:p-6 relative overflow-hidden bg-gradient-to-br from-gray-50 via-white to-emerald-50/30">
    ...
    <div class="absolute top-[-15%] left-[-10%] w-[50%] h-[50%] bg-kementan-green/8 blur-[100px] rounded-full animate-pulse pointer-events-none" />
    <div
    ...
    />
    <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[30%] h-[30%] bg-emerald-500/5 blur-[80px] rounded-full pointer-events-none" />
    ...
    >
      ...
      <div class="bg-white/80 backdrop-blur-xl rounded-[1.5rem] md:rounded-[2rem] overflow-hidden flex flex-col md:flex-row shadow-[0_20px_60px_rgba(0,0,0,0.08)] border border-white/60 ring-1 ring-black/5">
        ...
        <div class="flex-1 p-6 sm:p-8 md:p-10 lg:p-12 flex flex-col justify-center">
          ...
          <p class="text-gray-400 mb-8 text-sm font-medium">
          ...
          >
            ...
            <div class="space-y-1.5">
              ...
              <p
                v-if="password && password.length < 6 && password.length > 0"
                class="text-[11px] text-orange-500 ml-1 font-medium"
              >
                Minimal 6 karakter.
              </p>
            </div>
